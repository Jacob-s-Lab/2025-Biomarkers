...
[Markdup_file tree](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/wk5_tree.txt)
...
1. Enter [bwa_markdup.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/bwa_markdup.sh)
  ```
  vim bwa_markdup.sh
  ```
...
1. 進入 [bwa_markdup.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/bwa_markdup.sh).
```
vim bwa_markdup.sh
```
