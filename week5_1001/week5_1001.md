...
[Markdup_file tree](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week5_1001/wk5_tree.txt)
...
3. Copy the executable files needed for the class.
  ```marksown=
  rsync -avz /work/evelyn92/2025Biomarker/bwa_markdup.sh /work/username/alignment
  ```

### Step 2: Modify the Analysis Executable
1. Enter [bwa_markdup.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week5_1001/bwa_markdup.sh)
  ```
  vim bwa_markdup.sh
  ```
...
1. 進入 [bwa_markdup.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week5_1001/bwa_markdup.sh).
```
vim bwa_markdup.sh
```
