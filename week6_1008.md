...
[Variantcalling_file tree](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/wk6_tree.txt)
...
1. Enter [variantcalling.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/variantcalling.sh).
```
...
## 本次課程的樹狀資料結構
[Variantcalling](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/wk6_tree.txt)
...
1. 進入 [variantcalling.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/variantcalling.sh).
```
vim variantcalling.sh
```
