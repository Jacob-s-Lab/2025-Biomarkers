...
[Annotation_file tree](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week7_1015/wk7_tree.txt)
...
1. Enter [vep.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week7_1015/vep.sh)
```
vim vep.sh
```
...
### step 2 修改分析執行檔
1. 進入 [vep.sh](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/week7_1015/vep.sh).
```
vim vep.sh
```
