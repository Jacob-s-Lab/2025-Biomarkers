...
#### 1. Open the [SH file](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/tutorial.sh)
```
vim file_name.sh  
...
2. Open [`Mutect2.sh`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/Mutect2.sh), copy its contents, and replace the variant calling section in `tutorial_mutect2.sh` with this content.
...
#### 1. 打開 [sh 檔](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/tutorial.sh)
```
vim file_name.sh  
...
cp tutorial.sh tutorial_mutect2.sh
```
2. 開啟 [`Mutect2.sh`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/Mutect2.sh)，並將裡面的內容複製並置換 `tutorial_mutect2.sh`中 variant calling 的部分。
