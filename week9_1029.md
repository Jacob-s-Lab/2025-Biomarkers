...
### Step 1 : Run [`hap.py`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/hap.sh)
...
### Step 2: Use [`rocplot.sh`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/rocplot.sh) results to create an ROC plot.
...
### step 1 : 執行 [`hap.py`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/hap.sh)
...
### step 2 : 利用 [`rocplot.sh`](https://github.com/Jacob-s-Lab/2025-Biomarkers/blob/main/rocplot.sh) 結果製作 ROC 圖
